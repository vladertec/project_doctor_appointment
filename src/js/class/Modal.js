  ...
  <div class="dentist-input-wrap"></div>
    ...
    <option class = "modal-priority-emergency" value="Emergency">Неотложная</option>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary submit-btn">Сохранить изменения</button>
        </div>
      </div>
    </div>
    </div>
...
getInputValues(){
  this.name = document.querySelector(".first-name-input").value
  this.surname = document.querySelector(".last-name-input").value
  this.doctor  = document.querySelector(".modal-doctor-select").value
  this.urgency  = document.querySelector(".modal-urgency-select").value
